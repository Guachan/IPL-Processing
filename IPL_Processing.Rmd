...
OG22_T5_250_0_3_SC_2 <- read_csv("C:/Users/canta/IPL-Processing/Data/OG22_T5-250-0-3_SC_2.csv")
OG23_T5_60_0_3_SC_2 <- read_csv("C:/Users/canta/IPL-Processing/Data/OG23_T5-60-0-3_SC_2.csv")
OG24_T5_45_0_3_SC_2 <- read_csv("C:/Users/canta/IPL-Processing/Data/OG24_T5-45-0-3_SC_2.csv")
OG31_T3_55_0_3_SC_2 <- read_csv("C:/Users/canta/IPL-Processing/Data/OG31_T3-55-0-3_SC_2.csv")
OG32_T3_25_0_3_SC_2 <- read_csv("C:/Users/canta/IPL-Processing/Data/OG32_T3-25-0-3_SC_2.csv")
OG33_T3_9_0_3_SC_2 <- read_csv("C:/Users/canta/IPL-Processing/Data/OG33_T3-9-0-3_SC_2.csv")
OG34_T5_35_0_3_SC_2 <- read_csv("C:/Users/canta/IPL-Processing/Data/OG34_T5-35-0-3_SC_2.csv")
OG39_T5_28_0_3_SC_2 <- read_csv("C:/Users/canta/IPL-Processing/Data/OG39_T5-28-0-3_SC_2.csv")
QOG30_T3_250_0_3_SC_2 <- read_csv("C:/Users/canta/IPL-Processing/Data/QOG30_T3-250-0-3_SC_2.csv")
QOG37_T3_14_0_3_SC_2 <- read_csv("C:/Users/canta/IPL-Processing/Data/QOG37_T3-14-0-3_SC_2.csv")
...
ARCHAEOL_Import <- read_excel("C:/Users/canta/IPL-Processing/Data/Compound Calibration Report_IPLS standards.xlsx", 
    sheet = "Sheet1ARCHAEOL", na = "N/A", 
    skip = 33) %>% mutate(
      Compound = 'ARCHAEOL'
    )

MGDAG_Import <- read_excel("C:/Users/canta/IPL-Processing/Data/Compound Calibration Report_IPLS standards.xlsx", 
    sheet = "Sheet1MGDG", na = "N/A", 
    skip = 33) %>% mutate(
      Compound = 'MGDAG'
    )

Gly_Cer_Import <- read_excel("C:/Users/canta/IPL-Processing/Data/Compound Calibration Report_IPLS standards.xlsx", 
    sheet = "Sheet11-GLC-CER", na = "N/A", 
    skip = 33) %>% mutate(
      Compound = 'Gly-Cer'
    )

DGTS_Import <- read_excel("C:/Users/canta/IPL-Processing/Data/Compound Calibration Report_IPLS standards.xlsx", 
    sheet = "Sheet1DGTS", na = "N/A", 
    skip = 33) %>% mutate(
      Compound = 'DGTS'
    )

C16PA_Import <- read_excel("C:/Users/canta/IPL-Processing/Data/Compound Calibration Report_IPLS standards.xlsx", 
    sheet = "Sheet1C16PA", na = "N/A", 
    skip = 33) %>% mutate(
      Compound = 'PA'
    )

C16PDME_Import <- read_excel("C:/Users/canta/IPL-Processing/Data/Compound Calibration Report_IPLS standards.xlsx", 
    sheet = "Sheet1C16PDME", na = "N/A", 
    skip = 33) %>% mutate(
      Compound = 'PDME'
    )

C16PME_Import <- read_excel("C:/Users/canta/IPL-Processing/Data/Compound Calibration Report_IPLS standards.xlsx", 
    sheet = "Sheet1C16PME", na = "N/A", 
    skip = 33) %>% mutate(
      Compound = 'PME'
    )

C16PE_Import <- read_excel("C:/Users/canta/IPL-Processing/Data/Compound Calibration Report_IPLS standards.xlsx", 
    sheet = "Sheet1C16-PE", na = "N/A", 
    skip = 33) %>% mutate(
      Compound = 'PE'
    )

C16PG_Import <- read_excel("C:/Users/canta/IPL-Processing/Data/Compound Calibration Report_IPLS standards.xlsx", 
    sheet = "Sheet1C16-PG", na = "N/A", 
    skip = 33) %>% mutate(
      Compound = 'PG'
    )

SQDAG_Import <- read_excel("C:/Users/canta/IPL-Processing/Data/Compound Calibration Report_IPLS standards.xlsx", 
    sheet = "Sheet1SQ-DAG", na = "N/A", 
    skip = 33) %>% mutate(
      Compound = 'SQDAG'
    )

PC_ARCHAEOL_Import <- read_excel("C:/Users/canta/IPL-Processing/Data/Compound Calibration Report_IPLS standards.xlsx", 
    sheet = "Sheet1PC-ARCHAEOL", na = "N/A", 
    skip = 33) %>% mutate(
      Compound = 'PC-ARCHAEOL'
    )

PE_ARCHAEOL_Import <- read_excel("C:/Users/canta/IPL-Processing/Data/Compound Calibration Report_IPLS standards.xlsx", 
    sheet = "Sheet1PE-AR", na = "N/A", 
    skip = 33) %>% mutate(
      Compound = 'PE-ARCHAEOL'
    )

C21_PC_Import <- read_excel("C:/Users/canta/IPL-Processing/Data/Compound Calibration Report_IPLS standards.xlsx", 
    sheet = "Sheet1C21-PC", na = "N/A", 
    skip = 33) %>% mutate(
      Compound = 'PC-C21'
    )

C16_PC_Import <- read_excel("C:/Users/canta/IPL-Processing/Data/Compound Calibration Report_IPLS standards.xlsx", 
    sheet = "Sheet1C16-PC", na = "N/A", 
    skip = 33) %>% mutate(
      Compound = 'PC-C16'
    )

DGDAG_Import <- read_excel("C:/Users/canta/IPL-Processing/Data/Compound Calibration Report_IPLS standards.xlsx", 
    sheet = "Sheet1DGDG", na = "N/A", 
    skip = 33) %>% mutate(
      Compound = 'DGDAG'
    )

C16_PAF_Import <- read_excel("C:/Users/canta/IPL-Processing/Data/Compound Calibration Report_IPLS standards.xlsx", 
...
ggplot(calib_standards, aes(x = Std_Amount, y = Std_Area)) +
  ...
  scale_color_manual(name = "Fits",
                     breaks = c("Linear"),
                     values = c("blue")) +
 stat_smooth(method = "nls", formula = y ~ a*exp(b*x), start = list(a=1,b=1),
...
## How to add an exponential model  to compare??
...
>>>>>>> 654922c857d6812f5377ae520f5302aece3ae782
